...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Type the item number you want to order: ")
            ...
            if menu_item_number.isdigit():
                ...
                if menu_item_number in menu_items.keys():
                    ...
                    print(f"You setected {selected_item['Item name']} which costs ${selected_item['Price']}")
                    ...
                    print(f"{quantity} x {selected_item['Item name']} added to your oder.")
                    
                    # Tell the customer that their input isn't valid
                else:
                    print(f"Item number {menu_item_number} is not valid.")
